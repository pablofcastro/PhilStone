...
property: !EF[phil1.own(left) && phil2.own(left) && phil3.own(left) && phil4.own(left) && phil5.own(left) && phil6.own(left) && phil7.own(left)] && !EF[phil1.own(right) && phil2.own(right) && phil3.own(right) && phil4.own(right) && phil5.own(right) && phil6.own(right) && phil7.own(right)]; 
